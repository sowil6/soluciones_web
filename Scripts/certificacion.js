...
function Boton_consultaEstudiante(){
	var documento_=	document.getElementById('documento').value;
	 var parametros={
		"ejecutar":"consulta_certificados",
...
function ConsultaDatosInscritos(id_estudiante_,documento_estudiante_){//en uso
	//alert("sirve "+id_+"  ----"+id_estudiante_);
document.getElementById('la_id').innerHTML=id_estudiante;
document.getElementById("btngrabar").innerHTML ="Actualizar";//cambiar el nombre del boton grabar a Actualizar
...
/*var programa_ = document.getElementById('programa').value;*/
        ...
        var parametros={
		"ejecutar":"consulta",
		"id_estudio":documento_estudiante_,
		"documento":documento_,
		"id":id_estudiante_
		/*"programa": programa_ */
        };
			...
			success: function (resulta){
				...
				//console.log("result"+resulta);
					console.log("result"+responsee+resulta)
...
if(response[0].estado){document.getElementById('estado_estudiante').value=response[0].estado;}
...
var id_estudio_="";//id_estudiante de programa inscrito tomado del listbox Tus inscripciones
...
//alert(estado_estudiante_+" -- "+observacion_);
...
function Eliminar(id_estudiante, documento_estudiante_,documento_){
